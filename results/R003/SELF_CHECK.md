...
- `rnafold_status`：**ok**
- `rnafold_mfe`（若已计算）：**-72.6**
- `mrna_stability_status`：**ok**
- `RNAplfold mean_unpaired_l1`：**0.655966**
- `RNAplfold mean_unpaired_l10`：**0.528729**
...
- `public_case_003`：`not_returned`（未返回），报告 `results/R003/simhub_evidence/public_case_003/SIMHUB_EVIDENCE.md`
